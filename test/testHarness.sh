...
# 0x0138FF00028B\ 
  ...
  0x00A0FF000288,0x78de61c02efe9205F23dc3c58812d0B2815ee15F\
  0x00A0FF00028B,0x9C63fde003d4279962e158f21E92D09f064BA48a\
  #   0x00A0FF000288,0x78de61c02efe9205F23dc3c58812d0B2815ee15F\
  # 0x00A0FF00028B,0x9C63fde003d4279962e158f21E92D09f064BA48a\
)
...
for SERIES_STRATEGY in ${SERIES_STRATEGIES[@]}; do
  ...
  for ILK_ID_ in ${ILK_IDS[@]}; do
    ...
    STRATEGY=$STRATEGY_ SERIES_ID=$SERIES_ID_ ILK_ID=$ILK_ID_ forge test -c test/RecipeHarness.t.sol -vvvv -m testRedeemfyETH
  done
done